...
var Demo = function() {
        var n = document.querySelector("#demoForm"),
            ...
            b = localStorage.getItem("dashkitNavPosition") ? localStorage.getItem("dashkitNavPosition") : "sidenav",
            v = localStorage.getItem("dashkitSidebarColor") ? localStorage.getItem("dashkitSidebarColor") : "default";
        document.addEventListener("DOMContentLoaded", function() {
            var a, e, t, o, r, l;
            "light" == (a = colorScheme) ? (p.disabled = !1, h.disabled = !0) : "dark" == a && (p.disabled = !0, h.disabled = !1),
                function(a) {
                    if (s && i && c && d)
                        if ("topnav" == a) {
                            t(i), t(c);
